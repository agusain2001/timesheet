...
- [FastAPI AI Integration Guide](https://fastapi.tiangolo.com/)
- [LightIDEA API Reference](http://localhost:8000/api/docs)

### Code Examples
- [AI Chatbot Implementation](file:///G:/LightIDEA/backend/app/routers/chatbot.py)
- [Task Intelligence Service](file:///G:/LightIDEA/backend/app/routers/ai_features.py)
- [Frontend AI Service](file:///G:/LightIDEA/frontend/services/ai.ts)

---

## 🤝 Contributing

To contribute new AI features:

1. Fork the repository
2. Create a feature branch (`git checkout -b feature/ai-new-feature`)
3. Implement your AI agent following the patterns above
...
- **GitHub Issues:** [Open an issue](https://github.com/agusain2001/timesheet/issues)
- **Email:** agusain2001@gmail.com
- **Documentation:** See [README.md](file:///G:/LightIDEA/README.md)
