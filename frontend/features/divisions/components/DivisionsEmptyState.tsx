...
export function DivisionsEmptyState() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center text-center gap-4">
      ...
      <p className="text-sm font-medium text-gray-400 max-w-xl">
        Manage and organize departments in one place, assign managers, track
        teams efficiently, and add a department to get started today.
      </p>
